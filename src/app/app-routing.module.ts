...
const routes: Routes = [
  { //La primera ruta es la ruta raíz (''), que se redirige al componente HomeComponent y utiliza el guardia HomeGuard para verificar si el usuario está autenticado.
    path: '',
    component: HomeComponent,
    canActivate: [HomeGuard]
  },

  { //La segunda ruta es la ruta de login ('login'), que se redirige al componente LoginComponent y utiliza el guardia LoginGuard para verificar si el usuario está autenticado.
    path: 'login',
    component: LoginComponent,
    canActivate: [LoginGuard]
  },

  { //La tercera ruta es la ruta de registro ('register'), que se redirige al componente RegisterComponent.
    path: 'register',
    component: RegisterComponent
  },

  { //La cuarta ruta es la ruta de catch-all ('**'), que se redirige a la ruta raíz ('') si no se encuentra una ruta que coincida.
    path: '**',
    pathMatch: 'full',
    redirectTo: '',
  }
